...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // valueString: string
    // string to replace value
    valueString: kvLookup('valueString', config, dataset, ''),
  ...
  } else if (obj.config.valueString){
    obj.originalValue = obj.config.valueString
...
/** Refresh gauge level */
JustGage.prototype.refresh = function(val, max, title, label) {
